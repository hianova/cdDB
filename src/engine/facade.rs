...
use alloc::sync::Arc;
use alloc::vec::Vec;
#[doc = " A high-level unified persistence trait for cdDB tiered storage backend."]
#[doc = " Exposes standard CRUD operations."]
pub trait CdDBStore {
    type Value;
    #[doc = " Write a key-value attribute associated with a given entity."]
    fn put(&self, entity_id: usize, key: &str, value: Self::Value) -> Result<(), &'static str>;
    #[doc = " Retrieve the key-value attribute associated with a given entity."]
    fn get(&self, entity_id: usize, key: &str) -> Option<Self::Value>;
    #[doc = " Delete all attributes associated with a given entity."]
    fn delete(&self, entity_id: usize) -> Result<(), &'static str>;
}
#[doc = " A high-level facade representing a single registered partition."]
#[doc = " Provides synchronous read/write methods to hide execution channel boilerplate."]
#[cfg(feature = "std")]
#[repr(C, align(64))]
...
impl<'a, const N: usize> CdDBPartition<'a, N> {
    #[doc = " Write a string attribute to this partition."]
    ...
    #[doc = " Write a binary blob attribute to this partition."]
    pub fn write_blob(
        &self,
        entity_id: usize,
        attr: &str,
    ...
    #[doc = " Write an integer attribute to this partition."]
    pub fn write_int(
        &self,
        entity_id: usize,
        attr: &str,
        ...
        let mut attributes_int = crate::core::commands::Attributes::new();
        attributes_int.insert(attr.to_string(), value);
        let cmd = crate::core::commands::WriteCommand::Insert {
            entity_id,
            attributes: crate::core::commands::Attributes::new(),
            attributes_int,
    ...
    #[doc = " Write a fast epoch-based snapshot payload."]
    ...
    #[doc = " Read a binary blob attribute."]
    ...
    #[doc = " Read an integer attribute."]
    pub fn read_int(&self, entity_id: usize, attr: &str) -> Option<u32> {
        let node = crate::core::query::QueryNode::Get { entity_id, attr };
        let mut res = None;
        self.dispatcher
            .execute_batch(&self.name, &[node], |result| {
                if let crate::core::query::QueryResult::Int(i) = result {
                    res = Some(i);
                }
            });
        res
    }
    #[doc = " Delete all attributes of an entity."]
    pub fn delete(&self, entity_id: usize) -> Result<(), &'static str> {
        let cmd = crate::core::commands::WriteCommand::Delete { entity_id };
        self.writer.send(cmd)
    }
}
#[doc = " A standard string attribute store wrapping `CdDBPartition`."]
#[cfg(feature = "std")]
#[repr(C, align(64))]
...
#[doc = " A standard binary blob attribute store wrapping `CdDBPartition`."]
#[cfg(feature = "std")]
#[repr(C, align(64))]
