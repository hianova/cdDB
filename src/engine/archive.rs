...
#[cfg(feature = "std")]
use std::io::Write;
#[doc = " A Cold Storage Archiver to persist old cdDB records for Digital Preservation."]
#[doc = " Supports cryptographic provenance hashing to prevent bit-rot and tampering."]
#[cfg(feature = "std")]
#[repr(C, align(64))]
...
impl ColdStorageArchiver {
    ...
    #[doc = " Serializes a WriteCommand into a deterministic byte array for hashing."]
    ...
    #[doc = " Archives a batch of commands to cold storage with a SHA-256 signature."]
    pub fn archive_batch(
        ...
        file.write_all(&data_payload)
            .map_err(|_| "Failed to write payload")?;
        file.write_all(b"=====================\n\n")
